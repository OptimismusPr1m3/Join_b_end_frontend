...
function loadContacts() {
    ...
    contacts.forEach((contact, index) => {
        let initials = getInitials(contact.first_name, contact.last_name);
        ...
        <div id="c${index}" class="contact" onclick="showContactInfo(${index})">
            ...
            <div class="contact-name-mail">
                <p class="f-size">${contact.first_name} ${contact.last_name} </p>
...
function checkIfFirstNameOrLastName(contact) {
    if (contact.first_name != '') {
        return document.getElementById(contact.first_name.charAt(0).toLowerCase());
    } else {
        return document.getElementById(contact.last_name.charAt(0).toLowerCase());
    }
}
...
function getProfilePic(index) {
    ...
    let initials = getInitials(contacts[index].first_name, contacts[index].last_name);
...
async function overwriteContact(firstLastName, mail, tel, contact) {
    contact.first_name = firstLastName[0];
